...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "A ATM é uma empresa de segurança de Software a nível empresarial " +
                "com a missão de proteger os dados com excelência e qualidade.";
        ...
        return new AboutPage(getActivity())
                ...
                .addGroup("Entre em coontato")
                .addEmail("atendimento@atmconsultoria.com.br", "Envie um email")
                .addWebsite("https://www.atmconsultoria.com.br", "Acesse nosso site")
